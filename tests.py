...
def test16():
    assert roman.convert_to_int("MCMLXXXVIII") == 1988, "Test16, should be 1988"
...
def test29():
    assert roman.convert_to_int("MMMCMXCIX") == 3999, "Test29 should be 3999"

def test30():
    assert roman.convert_to_int("LXXXIX") == 89, "Test30 should be 89"

def test31():
    assert roman.convert_to_int("MCDLXXXVIII") == 1488, "Test31 should be 1488"
